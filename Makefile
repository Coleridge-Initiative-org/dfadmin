...
test:
	docker-compose exec web coverage run --source='.' manage.py test --noinput -v2 --parallel 1
	docker-compose exec web coverage xml
	docker-compose exec web coverage report

test-quick:
	docker-compose exec web coverage run --source='.' manage.py test --keepdb --noinput -v2 --parallel 1
	docker-compose exec web coverage xml
	docker-compose exec web coverage report
